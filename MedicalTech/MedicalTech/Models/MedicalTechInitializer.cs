...
namespace MedicalTech.Models
{
    ...
    public class MedicalTechInitializer : DropCreateDatabaseAlways<MedicalTechContext>
    {
        protected override void Seed(MedicalTechContext context)
        {
            base.Seed(context); 
        }
        private readonly MedicalTechContext _context;
        public MedicalTechInitializer(MedicalTechContext context)
        {
            _context = context;
        }
        public void Seed()
        {
            ...
            _context.Enfermeiros.AddRange(enfermeiros);
